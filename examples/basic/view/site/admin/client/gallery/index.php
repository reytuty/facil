...
<a href="<?php echo Config::getRootPath('backend/client/gallery/upload/type.'.$HttpContentResult->gallery_type.'/id.'.$HttpContentResult->vo->id); ?>" class="iconlink" id="upload" style="margin-top:15px; margin-left: 15px;"><img src="<?php echo Config::getAsset('backend/assets/images/icons/small/black/video.png'); ?>" class="mgright5" alt=""> <span>Upload</span></a>
    <div class="left">
