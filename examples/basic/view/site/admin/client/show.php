...
function tooglePublished(element){
	...
	$.ajax({
		  url: ROOT_URL+'backend/product/update_active/id.'+id+"/active."+active+"/",
		  dataType: 'json',
		  data: { },
		...
		<table cellpadding="0" cellspacing="0" border="0" class="dyntable" id="example">
            <thead>
                <tr>
                    ...
                    <th class="head1" width="40%">Cliente</th>
            ...
            <tbody>    
            	...
            	<tr class="gradeA">
                    ...
                    <td><a href="<?php echo Config::getRootPath("cliente/id.".$row->id); ?>"/><?php echo $row->title; ?></a></td>
                    <td><?php echo $row->slug; ?></td>
                    <td>
                    	<?php
                    	echo"<a href=\"".Config::getRootPath("backend/client/change/id.".$row->id)."\" class=\"iconlink2\"><img src=\"".Config::getAsset('backend/assets/images/icons/small/black/edit.png')."\" alt=\"\"></a>
                    	<a href=\"".Config::getRootPath("backend/client/delete/id.".$row->id)."\" class=\"iconlink2\"><img src=\"".Config::getAsset('backend/assets/images/icons/small/black/close.png')."\" alt=\"\"></a>"
                    	?>
                    </td>
                </tr>                      
                <?php }} ?>
