...
<body style="overflow:hidden;">
		<br>
		<form id="fileupload" action="<?php echo Config::getRootPath('backend/info_segmento/commit_gallery/type.'.$HttpContentResult->gallery_type.'/id.'.$HttpContentResult->vo->id); ?>" method="POST" enctype="multipart/form-data">
		<?php 
