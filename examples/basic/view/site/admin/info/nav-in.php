	...
	<div id="accordion">
        ...
        <div class="content" style="display: block;">
        	<ul class="leftmenu">
                ...
                <li <?php if(count($array_folders) > 2 && $array_folders[1]=='info' && $array_folders[2]=='show'){echo(' class="current"');}?>><a href="<?php echo Config::getRootPath('backend/info/add/'); ?>" class="table">Add Infos</a></li>
            </ul>
        </div>
