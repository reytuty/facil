		...
		<table cellpadding="0" cellspacing="0" border="0" class="dyntable" id="example">
            ...
            <tbody>    
            	...
            	<tr class="gradeA">
                    ...
                    <td>
                    	<?php
                    	echo"<a href=\"".Config::getRootPath("backend/info/change/id.".$row->id)."\" class=\"iconlink2\"><img src=\"".Config::getAsset('backend/assets/images/icons/small/black/edit.png')."\" alt=\"\"></a>
                    	<a href=\"".Config::getRootPath("backend/info/delete/id.".$row->id)."\" class=\"iconlink2\"><img src=\"".Config::getAsset('backend/assets/images/icons/small/black/close.png')."\" alt=\"\"></a>"
                    	?>
                    </td>
                </tr>                      
                <?php }} ?>
