...
<div class="sidebar">
	<div id="accordion">
        ...
        <div class="content" style="display: block;">
        	<ul class="leftmenu">
            	<li <?php if(count($array_folders) > 2 && $array_folders[2]=='change'){echo(' class="current"');}?>><a href="<?php echo Config::getRootPath('backend/info/change/id.'.$HttpContentResult->vo->id); ?>" class="table">Infos</a></li>
                <li <?php if(count($array_folders) > 2 && $array_folders[2]=='gallery'){echo(' class="current"');}?>><a href="<?php echo Config::getRootPath('backend/info/gallery/type.gallery/id.'.$HttpContentResult->vo->id); ?>" class="form">Galeria</a></li>
            </ul>
        </div>
