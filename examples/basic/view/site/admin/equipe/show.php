...
function tooglePublished(element){
	...
	$.ajax({
		  url: ROOT_PATH+'backend/equipe/update_active/id.'+id+"/active."+active+"/",
		  dataType: 'json',
		  data: { },
		...
		<table cellpadding="0" cellspacing="0" border="0" class="dyntable" id="example">
            <thead>
                <tr>
                    ...
                    <th class="head1" width="35%">Membro</th>
            ...
            <tbody>    
            	...
            	<tr class="gradeA">
                    ...
                    <td>
                    	<?php
                    	echo"<a href=\"".Config::getRootPath("backend/equipe/change/id.".$row->id)."\" class=\"iconlink2\"><img src=\"".Config::getAsset('backend/assets/images/icons/small/black/edit.png')."\" alt=\"\"></a>
                    	<a href=\"".Config::getRootPath("backend/equipe/delete/id.".$row->id)."\" class=\"iconlink2\"><img src=\"".Config::getAsset('backend/assets/images/icons/small/black/close.png')."\" alt=\"\"></a>"
                    	?>
                    </td>
                </tr>                      
                <?php }} ?>
