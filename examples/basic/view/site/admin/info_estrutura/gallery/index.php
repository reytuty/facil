...
<?php include(Config::getFolderView('/backend/info_estrutura/nav-detail.php')); ?>
<div class="maincontent">
<a href="<?php echo Config::getRootPath('backend/info_estrutura/gallery/upload/type.'.$HttpContentResult->gallery_type.'/id.'.$HttpContentResult->vo->id); ?>" class="iconlink" id="upload" style="margin-top:15px; margin-left: 15px;"><img src="<?php echo Config::getAsset('backend/assets/images/icons/small/black/video.png'); ?>" class="mgright5" alt=""> <span>Upload</span></a>
    <div class="left">
                ...
                <div class="sTableWrapper">
                    ...
                    <table cellpadding="0" cellspacing="0" class="sTable" width="100%">
                        ...
                        <tr>
                            ...
                            <td align="center"><?php
                    	echo"<a href=\"".Config::getRootPath("backend/info_estrutura/delete_image/info_id.".$HttpContentResult->vo->id."/id.".$row->id."/type.".$HttpContentResult->gallery_type)."\" class=\"iconlink2\"><img src=\"".Config::getAsset('backend/assets/images/icons/small/black/close.png')."\" alt=\"\"></a>"
                    	?></td>
                        </tr>
                         <?php 
		                }}
