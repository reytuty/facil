...
<div class="maincontent">	
	<form action="<?php echo Config::getRootPath('backend/info_estrutura/commit/id.'.$id); ?>" method="post">
        	...
        	<div class="form_default">
        			...
        			?>     
        			<input type="hidden" value="backend/info_estrutura/change/id.<?php echo $id; ?>" name="to" />
                    <p>
