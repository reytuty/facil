...
function toogleSelect(element){
	...
	$.ajax({
		  url: ROOT_PATH+'backend/product/family/'+method,
		  dataType: 'json',
...
<div class="maincontent">	
	<form action="<?php echo Config::getRootPath('backend/product/family/commit/id.'.$id); ?>" method="post">        
	...
	<div class="left">
		<div class="form_default">
			...
			?> 
			<input type="hidden" value="backend/product/family/show" name="to" />
	        <p>
