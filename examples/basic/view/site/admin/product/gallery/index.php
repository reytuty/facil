...
<a href="<?php echo Config::getRootPath('backend/product/gallery/upload/type.'.$HttpContentResult->gallery_type.'/id.'.$HttpContentResult->vo->id); ?>" class="iconlink" id="upload" style="margin-top:15px; margin-left: 15px;"><img src="<?php echo Config::getAsset('backend/assets/images/icons/small/black/video.png'); ?>" class="mgright5" alt=""> <span>Upload</span></a>
    <div class="left">
        <div id="gallery" class="gallery">        
            ...
            <div id="gridview" class="thumbview">
                ...
                <ul>
                    <li>
                        <div class="thumb">
                            <img src="<?php echo Config::getRootPath("image/get_image/image_id.".$row->id."/max_width.600/max_height.550/crop.1") ?>" alt="" />
                            <div class="info">                             
                                <p class="menu">
                ...
                <div class="sTableWrapper">
                    ...
                    <table cellpadding="0" cellspacing="0" class="sTable" width="100%">
                        ...
                        <tr>
                            ...
                            <td align="center"><?php
                    	echo"<a href=\"".Config::getRootPath("backend/product/delete_image/product_id.".$HttpContentResult->vo->id."/id.".$row->id."/type.".$HttpContentResult->gallery_type)."\" class=\"iconlink2\"><img src=\"".Config::getAsset('backend/assets/images/icons/small/black/close.png')."\" alt=\"\"></a>"
                    	?></td>
                        </tr>
                         <?php 
		                }}
