...
<body style="overflow:hidden;">
		<br>
		<form id="fileupload" action="<?php echo Config::getRootPath('backend/product/commit_gallery/type.'.$HttpContentResult->gallery_type.'/id.'.$HttpContentResult->vo->id); ?>" method="POST" enctype="multipart/form-data">
		<?php 
        			...
        			?>
        			<input type="hidden" value="<?php echo $HttpContentResult->vo->author; ?>" name="author" />
        <div class="row">
