...
class MenuFooter extends Content{
	private $my_action 		= "admin/menu_footer/commit";
	private $my_redirect 	= "admin/menu_footer/select";
	...
	public function init(){
		...
		$SelectData->setGoToLocation(array("value"=>"admin/menu_footer"));
...
//																'Title',
		...
		$HttpContentResult->url_insert = Config::getRootPath("admin/menu_footer/insert/");
...
//		echo "cocococo";exit();
	...
	public function delete(){
		parent::delete();
		Navigation::redirect("admin/menu_footer");
		exit();
	}		
...
//														'Order'
		...
		$this->my_redirect = "admin/menu_footer/select/";
