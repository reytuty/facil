...
class InfoEstrutura extends Content implements HTTPControllerInterface{
	
	public function __construct($arrayRestFolder = NULL){
		parent::__construct($arrayRestFolder);
		//categoria produtos
		$this->category_id = 126;
		$this->my_redirect = "backend/info_estrutura/show";
		if(isset($_POST["to"])){
	...
	public function deleteImage(){
		...
		Navigation::redirect("backend/info/gallery/type.$galleryType/id.$info_id/");
	...
	public function deleteFile(){
		...
		Navigation::redirect("backend/info_estrutura/file/id.$info_id/");
		//echo $ReturnResultVO->toJson();
		exit();
	}
	...
	public function delete(){
		...
		Navigation::redirect("backend/info_estrutura/show/");
	}
}