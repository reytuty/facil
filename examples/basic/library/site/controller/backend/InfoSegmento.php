...
class InfoSegmento extends Content implements HTTPControllerInterface{
	
	public function __construct($arrayRestFolder = NULL){
		parent::__construct($arrayRestFolder);
		//categoria produtos
		$this->category_id = 125;
		$this->my_redirect = "backend/info_segmento/show";
		if(isset($_POST["to"])){
	...
	public function deleteImage(){
		...
		Navigation::redirect("backend/info_segmento/gallery/type.$galleryType/id.$info_id/");
	...
	public function deleteFile(){
		...
		Navigation::redirect("backend/info_segmento/file/id.$info_id/");
		//echo $ReturnResultVO->toJson();
		exit();
	}
