...
/**
 * 
 * classe para transformar xml em objeto
 * 
 * 
 * modo de usar:
 * 		require("SimpleXMLObject.class.php");
		//Aqui é pra criar a função, caso não exista
		...
		//pode ser um caminho de arquivo ou uma string com o conteudo em xml
		$XML = simplexml_load_file( $fonteXML );
		// para acessar o conte�do do XML, use o modo orientado a objeto
		print_r($XML);
