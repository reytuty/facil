...
/**
 * @author 		: Brian Vaughn
 * @reference 	: http://www.devshed.com/c/a/PHP/Dynamic-Watermarking-with-PHP/
 *
...
class Watermark{
	private static function imageCreateFromX($img_url){
		$type = DataHandler::returnExtensionOfFile($img_url);
	...
	private static function imageX($p_image, $p_img_url, $p_quality = 100){
		$type = DataHandler::returnExtensionOfFile($p_img_url);
		switch(strtolower($type)){
			case "gif":
