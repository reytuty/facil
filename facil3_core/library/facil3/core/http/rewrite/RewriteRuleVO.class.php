...
*/
include_once("library/facil3/core/http/interface/InterfaceRewriteRuleVO.php");
include_once("library/facil3/core/vo/ReturnResultVO.class.php");
class RewriteRuleVO implements InterfaceRewriteRuleVO {
	/**
	...
	public function RewriteRuleVO($valueToFind, $valueToRewrite, $description = NULL){
